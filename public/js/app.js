...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.searchResults, function(result) {
      return _c("li", [_vm._v(_vm._s(result.name))])
    }),
    0
  )
}
...
Vue.component('search-result', __webpack_require__(/*! ./components/SearchResult.vue */ "./resources/js/components/SearchResult.vue")["default"]);
...
var app = new Vue({
  ...
  methods: {
    runSearch: function runSearch(apiToken) {
...
__webpack_require__(/*! /Users/ostin/Documents/Sites/vineyard/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/ostin/Documents/Sites/vineyard/resources/sass/app.scss */"./resources/sass/app.scss");
